...
static const dongle_info dongle_registerd[]={\
    ...
    {"8888","0000","vlsicomm","/vendor/lib/modules/vlsicomm.ko","vmac0=wlan0 vmac1=p2p0 vif0opmode=1 vif1opmode=2 con_mode=0x06","aml_w1",0x0,"","",true,true},\
    {"8888","0000","w1u","/vendor/lib/modules/w1u.ko","hif_type=SDIO vmac0=wlan0 vmac1=p2p0 vif0opmode=1 vif1opmode=2 con_mode=0x06","aml_w1u_s",0x0,"","",true,true},\
    {"0000","0000","w1u","/vendor/lib/modules/w1u.ko","hif_type=USB vmac0=wlan0 vmac1=p2p0 vif0opmode=1 vif1opmode=2 con_mode=0x06","aml_w1u",0x4c55,"","",true,true},\
    ...
    {"0000","0000","bcmdhd","/vendor/lib/modules/bcmdhd.ko","firmware_path=/vendor/etc/wifi/43569/fw_bcm4358u_ag.bin nvram_path=/vendor/etc/wifi/43569/nvram_ap62x8.txt dhd_pwr_ctrl=0","bcm43569",0xbd27,"/vendor/etc/wifi/43569/fw_bcm4358u_ag","btusb",true,false}, \
    {"0000","0000","bcmdhd","/vendor/lib/modules/bcmdhd.ko","firmware_path=/vendor/etc/wifi/43569/fw_bcm4358u_ag.bin nvram_path=/vendor/etc/wifi/43569/nvram_ap62x8.txt dhd_pwr_ctrl=0","bcm43569",0x0bdc,"/vendor/etc/wifi/43569/fw_bcm4358u_ag","btusb",true,false}, \
    ...
    {"0000","0000","8821cu","/vendor/lib/modules/8821cu.ko","ifname=wlan0 if2name=p2p0","rtl8821cu",0xc820,"","rtk_btusb",true,true}, \
    ...
    {"0000","1101","wlan","/vendor/lib/modules/wlan_6391.ko","","qca6391",0x0,"","",true,false},\
    {"0000","1103","wlan","/vendor/lib/modules/wlan_206x.ko","","qca206x",0x0,"","",true,false},\
    {"0000","8852","8852ae","/vendor/lib/modules/8852ae.ko","ifname=wlan0 if2name=p2p0","rtl8852ae",0x0,"","",true,false},\
    {"0000","b852","8852be","/vendor/lib/modules/8852be.ko","ifname=wlan0 if2name=p2p0","rtl8852be",0x0,"","",true,false},\
