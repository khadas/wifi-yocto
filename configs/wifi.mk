...
ifeq (,$(wildcard vendor/wifi_driver/amlogic/w1u/project_w1u/vmac))
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*.txt,vendor/amlogic/common/wifi_bt/wifi/w1u,$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1u/)
else
PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*.txt,vendor/wifi_driver/amlogic/w1u/project_w1u/vmac,$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1u/)
endif
PRODUCT_COPY_FILES += vendor/amlogic/common/wifi_bt/wifi/w1u/iwpriv:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/w1u/iwpriv
WIFI_HIDL_FEATURE_DUAL_INTERFACE := false
endif
